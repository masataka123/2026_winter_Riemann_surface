こちらは2026年度秋冬学期 大阪大学 幾何学5 リーマン面・代数曲線論のホームページです.
...
- 2026/09/24 授業ページを作りました.

# 基本的事項

- 担当は岩井雅崇(いわいまさたか)です.
- この授業は対面授業です. 火曜4限(15:10-16:40)に演義を行います. 場所は理B308教室です. 
- 教科書は小木曽啓示 "代数曲線論" (朝倉書店)を用いる.
...
# 成績に関して
成績はレポートでつけます. 次の日時にレポートを配布する予定です. 
- レポート締切: 2027年1月26日 23:59:00 (日本標準時刻, GMT+9)
...
- もし資料を一括してダウンロードしたい場合は[こちらのページ](https://github.com/masataka123/2026_winter_Riemann_surface/tree/master/material)をご覧ください.
- 資料の著作権は岩井雅崇にあります. 
